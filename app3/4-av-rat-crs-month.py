...
data['Month'] = data['Timestamp'].dt.strftime('%Y-%m') # year-month
...
def app():
    ...
    p1 = jp.QDiv(a = wp, text = "These graphs represnet course review analysis", classes = "text-b1 text-center q-pa-md")
